...
public class LoginDTO implements Serializable {
	...
	private static final long serialVersionUID = -731971129973487755L;
	...
	public String toString() {
		return "LoginFormDTO [tipoUso=" + this.tipoUso + ", emailLogin=" + this.emailLogin + ", passLogin="
				+ this.passLogin + ", passNew=" + this.passNew + ", passRepetida=" + this.passRepetida + "]";
	}
}
