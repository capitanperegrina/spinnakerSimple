            ...
            <div class="row">
                <div class="col-lg-12">
					<div class="float-izda">
						<h1><c:out value="${signUpForm.nombre}"/> <c:out value="${signUpForm.apellidos}"/></h1>
					</div>                
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
							...
							<form:form action="adminElPerfil.action" method="post" class="fondogris" enctype="multipart/form-data" modelAttribute="signUpForm" id="signUpForm">
