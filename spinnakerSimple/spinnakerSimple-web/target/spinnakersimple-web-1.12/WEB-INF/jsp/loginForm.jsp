...
<%@ include file="/WEB-INF/jsp/includes/include.jsp" %>
	<spring:message code="global.password" var="passwordPlaceholder"/>
	<spring:message code="global.email" var="emailPlaceholder"/>
	
    <div class="container-fluid">
 
 		<form:form action="loginForm.action" method="post" class="fondogris" modelAttribute="loginForm" id="loginForm">
			...
			<div class="col-md-12 col-sm-12 fondogris">
				...
				<div class="col-md-7 col-sm-7">
					...
					<div class="text-center">
			    		<h2><spring:message code="loginForm.titulo"/></h2>
    					<div class="separa"><spring:message code="loginForm.registrese"/> <a href="signUp.action"><spring:message code="loginForm.registreseEnlace"/></a></div>
    					<div class="separa"><a href="resetPassRequest.action"><spring:message code="loginForm.recuperarClave"/></a></div>
					</div>
					...
					<div class="separa">
      					<label for="loginForm_passLogin">Password</label> <form:errors path="passLogin" cssClass="errorFormulario" />
    				</div>
					<div>
						<form:input type="password" path="passLogin" class="form-control ancho100" id="loginForm_passLogin" placeholder="Password"/>
    				</div>
 					<div class="clearfix"></div>
